...
class PointOfInterestDao extends GenericDao {
    ...
    protected function getCreateSql(): string {
        return 'INSERT INTO `' . $this->getTableName() . '` (`idLocation`, `poiName`, `attraction`, `intro`, `infoLink`, `poiMap`, `notes`) '
                . 'VALUES (:idLocation, :poiName, :attraction, :intro, :infoLink, :poiMap, :notes)';
    }
    ...
    protected function getUpdateSql(): string {
        ...
        . '`poiName`=:poiName, `attraction`=:attraction, `intro`=:intro, `infoLink`=:infoLink, `poiMap`=:poiMap, `notes`=:notes WHERE `id`=:id';
    }
